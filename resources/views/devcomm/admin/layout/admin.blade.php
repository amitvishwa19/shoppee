...
<head>
    ...
    <body class="dark-sidenav">
        ...
        {{-- For vue js --}}
            ...
            @include('devcomm.admin.partials.left-nav')
            ...
            <div  id="app" class="page-wrapper">
                ...
                <div class="page-content">
                    ...
                    @include('devcomm.admin.partials.top-nav')

                    <div class="container-fluid">

                        {{-- @include('devcomm.admin.partials.page-area') --}}
                        @yield('content')

                    </div><!-- container -->

                    {{-- <footer class="footer text-center text-sm-left">
                        &copy; 2021 Devlomatix Solutions <span class="d-none d-sm-inline-block float-right">Devloped by <i class="mdi mdi-heart text-danger"></i> Devlomatix Solutions</span>
                    </footer><!--end footer--> --}}
                </div>
                <!-- end page content -->
