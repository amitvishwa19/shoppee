...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <form method="post" action="{{route('product_category.store')}}" enctype="multipart/form-data" class="mg-t-30">
                @csrf
        ...
        <div class="col-sm-8">
            ...
            <div class="mg-t-50 mg-b-50">
                <div class="custom-dd dd" id="nestable_list_1">
                    @include('admin.pages.product_category.child_cat',$categories)
                </div>
            </div>
